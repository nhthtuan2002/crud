...
<div class="container">
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{$edit->nickName}}" class="form-control" id="usr" name="nickName">
        </div>
        <div class="form-group">
            <label for="usr">Blue Essense:</label>
            <input type="text" value="{{$edit->blue_essense}}" class="form-control" id="usr" name="blue_essense">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{$edit->thumbnail}}" class="form-control" id="usr" name="thumbnail">
        </div>
        <div class="form-group">
